...
class ImageUploadManager
{
    ...
    public const WATERMARK_IMAGE = 'images/assets/watermark.png';
     ...
     * @return void
     */
    final public static function deletePhoto(string $full_path): void
    {
    ...
    {
        if (!empty($path) && File::isFile(Storage::path($path))) {
